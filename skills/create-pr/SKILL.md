---
name: create-pr
description: Create a pull request for the current branch with a concise, narrative description written for senior developers. Commits any staged/unstaged changes, pushes the branch, and opens a PR against main via gh. Use this skill when the user asks to create or open a pull request / PR, or invokes create-pr.
---
